                    ...
                    <div class="flex flex-col mb-6">
                        ...
                        <div class="relative">
                            ...
                            <input id="email" type="email" name="email"
                                   ...
                                   placeholder="E-Mail Address" v-model="form.email"
                            />
                        </div>
                        <span class="text-sm text-red-600" v-text="form.errors.email"></span>
                    </div>
                    <div class="flex flex-col mb-6">
                        ...
                        <span class="text-sm text-red-600" v-text="form.errors.password"></span>
                    </div>
